...
pip install -r requirement.txt### 配置API Key

1. 注册阿里云账号并获取DashScope API Key
2. 配置API Key：
   - **命令行版本**: 编辑 `translation.py` 第218行填入API Key
   - **Web版本**: 在应用侧边栏输入API Key
